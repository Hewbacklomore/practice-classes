...
class PhoneBook {
    ...
    addFindedPerson(person) {
        ...
        // Will add this.#searchedUsers on input of search
    ...
    #setEvents() {
        ...
        input.addEventListener('input', () => {
           ...
           if(input.value !== '' && input.value !== null) {
                this.searchItem(input.value)
           }else {
               this.#itemsBox.style.display = 'none'
               this.#contactList.innerHTML = 'An item'
        ...
        btnPhone.addEventListener('click', ()=> {
                 ...
                 this.call(this.#contactList.textContent) 
    ...
    #eventOnSearch(person) {
        ...
        const contactsSearch = document.querySelector('.input-group-text');
    ...
    #eventOnRemoved() {
        ...
        const deletedBtn = document.querySelector('.btn btn-danger')
